...
var divToggle = document.querySelector(".toggle"); //class
var counter = document.querySelector("h1"); //tag
var btnIncrease = document.querySelector("#increase"); //id
var btnDecrease = document.querySelector("#decrease"); //id
